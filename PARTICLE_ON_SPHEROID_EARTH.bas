...
3021 'expert odd, novice even
3030 PRINT "TWO VIEWS"
3031 PRINT"expert":PRINT"novice"
3040 LOCATE 2,30:PRINT"on back"
3050 PSET(292,12),1
3060 LOCATE 21,6:PRINT"absolute"
3070 LOCATE 21,24:PRINT"relative"
3080 PSET(80,12),2:PSET(80,20),3

3090 PI = 3.14159: W=10: W2=W^2
3091 DT=0.005: FACT = 60:INC=PI/16

3100 GOSUB 3360
3110 LOCATE 23,1:INPUTE "lat";LA
3120 FOR I=1 TO 4:LA(I)=LA*PI/180
3121 LO(I) = -PI/2  :NEXT
3130 LAD(1)=0: LAD(3)=0
3131 LAD(2)=V:LAD(4)=LAD(2)
3140 LOCATE 23,20:INPUT "u,v";U,V
3150 LAD(1)=0: LAD(3)-0
3151 LAD(2)=V:LAD(4)=LAD(2)
3160 LOD(2)=U/COS(LA(1))+W : LOD(4)=LOD(2)
3170 LODD(2)=2*TAN(LA(2))*LAD(2)*LOD(2)
